...
<body>
	<div id="wrapper">
		...
		<div id="headBox">
			<div class="w960 oh">
				<a href="#" class="fl mt10"><img src="pic/logo.png" alt="logo" /></a>
				<nav id="navs" class="fr"> <a href="#">首页</a> <a href="#">资源中心</a> <a class="active"
					href="#"
				>管理中心</a> </nav>
			</div>
		</div>
			...
			<div class="content">
				...
				<div id="step2" class="step hide">
					<div class="w330">
						...
						<p>
							<a class="btn btn_primary mt20" href="javascript:;">登录邮箱</a>
						</p>
						<p class="c7b mt20">没有收到邮件？</p>
						<p>
							1. 请检查邮箱地址是否正确，你可以返回 <a href="#" class="c46" id="reWriteEmailBtn">重新填写</a>
						</p>
						<p>2. 检查你的邮件垃圾箱</p>
						<p>
				...
				<div id="step3" class="step hide">
					<form action="" method="post" id="step3_frm">
						...
						<div class="frm_control_group">
							...
							<div class="frm_controls">
								<input type="text" name="" class="frm_input phoneYzm" /> <input type="button" value="获取验证码"
		...
		<!-- // container end -->
		<footer id="footer" class="w960 oh"> <span class="fl">适用浏览器：IE8、360、FireFox、Chrome、Safari、Opera、傲游、搜狗、世界之窗.</span>
		<nav class="footNavs tr fr"> <a href="#">来源：sucaihuo.com</a> </nav> </footer>
		<!-- // footer end -->
	</div>
	<!-- // wrapper end -->
		...
		function showTips(txt, time, status) {
			...
			if (txt != '') {
				if (status != 0 && status != undefined) {
					htmlCon = '<div class="tipsBox" style="width:220px;padding:10px;background-color:#4AAF33;border-radius:4px;-webkit-border-radius: 4px;-moz-border-radius: 4px;color:#fff;box-shadow:0 0 3px #ddd inset;-webkit-box-shadow: 0 0 3px #ddd inset;text-align:center;position:fixed;top:25%;left:50%;z-index:999999;margin-left:-120px;"><img src="pic/ok.png" style="vertical-align: middle;margin-right:5px;" alt="OK，"/>'
							+ txt + '</div>';
				} else {
					htmlCon = '<div class="tipsBox" style="width:220px;padding:10px;background-color:#D84C31;border-radius:4px;-webkit-border-radius: 4px;-moz-border-radius: 4px;color:#fff;box-shadow:0 0 3px #ddd inset;-webkit-box-shadow: 0 0 3px #ddd inset;text-align:center;position:fixed;top:25%;left:50%;z-index:999999;margin-left:-120px;"><img src="pic/err.png" style="vertical-align: middle;margin-right:5px;" alt="Error，"/>'
							+ txt + '</div>';
				}
