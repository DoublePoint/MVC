...
//                });
                ...
                var setting = {
                		...
                		async : {
                			enable : true,
                			showLine : false,
                			url : $$pageContextPath + "/template/xt/cd/tree/datalist?isHasRoot=true",
        ...
        var reElem = $([
            ...
            (disabled ? (' ' + DISABLED) : '') +
            '">', '<i class="layui-edge"></i></div>', '<ul id="' + treeid + '" class="layui-anim layui-anim-upbit layui-tree ztree"></ul>', '</div>'
        ].join(''));
     ...
     */
    function isJson(obj) {
        return typeof (obj) == "object" && (Object.prototype.toString.call(obj).toLowerCase() == "[object object]"||Object.prototype.toString.call(obj).toLowerCase() == "[object object]") && !obj.length;
    }
    // 导出组件
