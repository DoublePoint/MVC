(function($) {
	var componentTemplate='<div class="layui-inline" >'
		...
		+ '</div>' + '</div>';
	component(_LL_Constant._ConstantComponentMap._FormSwitch,componentTemplate);
})(jQuery);

function FormSwitch(domId) {
...
(function() {
	...
	// 将实例作为子类的原型
	FormSwitch.prototype = new Super();
	FormSwitch.prototype.constructor = FormSwitch; // 需要修复下构造函数
})();
