		...
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-body" id="admin-body">
				...
				>
					...
					<div id="layui-tab-content" class="layui-tab-content" style="min-height: 150px; padding: 0px 0 0 0;">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/template/sys/index/indexScript.js"></script>
</html>