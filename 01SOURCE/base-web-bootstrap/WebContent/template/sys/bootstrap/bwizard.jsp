				...
				<ll-step title="实体类名过滤">
						<ll-filllayout > 
							<ll-fillarea-tb showtitle="true" title="实体类名过滤1" showborder="false">
									<ll-ajaxdatagrid  id="gridResource2"  onrowclick="rowClickTest()"  onpageclick="retrieveAjaxDataGrid"  ondblclick="dbclickgrid(1)"  datasource="/template/sys/tables">  
				                    <ll-gridcheck></ll-gridcheck>  
				                    <ll-gridrow  field="tableName"  title="过滤字符串"></ll-gridrow>  
				                  </ll-ajaxdatagrid>  
							</ll-fillarea-tb>
						</ll-filllayout>
				</ll-step>
