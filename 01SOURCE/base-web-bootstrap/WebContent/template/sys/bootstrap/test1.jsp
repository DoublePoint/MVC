...
<link rel="stylesheet" href="${pageContext.request.contextPath}/template/bootstrap-4.0.0-dist/css/bootstrap.min.css" >
...
<script type="text/javascript"  src="${pageContext.request.contextPath}/template/js/jquery-1.12.4.js"></script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/template/bootstrap-4.0.0-dist/js/bootstrap.min.js" ></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/template/bootstrap-select/dist/js/bootstrap-select.js" ></script>
</head>
<body>
