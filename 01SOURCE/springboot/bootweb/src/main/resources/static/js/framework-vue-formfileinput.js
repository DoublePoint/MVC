(function($) {
	...
	_LL_Model.formFieldComponent(_LL_Constant._ConstantComponentMap._FormFileInput, componentTemplate, privateProps);

	_LL_Model.FormFileInput = function(domId) {
	...
	// 将实例作为子类的原型
	_LL_Model.FormFileInput.prototype = new Super();
	_LL_Model.FormFileInput.prototype.constructor = _LL_Model.FormFileInput; // 需要修复下构造函数
})(jQuery);