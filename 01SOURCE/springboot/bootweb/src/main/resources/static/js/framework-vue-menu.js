(function($) {
	...
	var arr = [ " fa-toggle-on ", " fa-bell ", " fa-circle-o ", " fa-code ", " fa-square-o ", " fa-bug ", " fa-edit ", " fa-eyedropper ", " fa-coffee ", " fa-flash ", " fa-key ",
			" fa-send ", " fa-recycle ", " fa-desktop ", " fa-anchor", " fa-sign-in ", " fa-flask ", " fa-plus ", ];
