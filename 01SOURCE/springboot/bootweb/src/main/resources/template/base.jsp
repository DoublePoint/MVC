...
<script src="${pageContext.request.contextPath}/template/js/framework-vue-card.js" charset="utf-8"></script>
...
<script src="${pageContext.request.contextPath}/template/js/framework-vue-formarea.js" charset="utf-8"></script>
