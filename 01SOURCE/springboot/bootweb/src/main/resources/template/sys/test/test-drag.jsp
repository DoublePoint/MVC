...
<body>
	<form>
		...
		<div id="right_div" class="ll:fill:area-lr">
			<ll:filllayout> <ll:fillareatb height="86"> <ll:ajaxform id="ajaxform" cols="3"
			...
			</select> <input type="button" class="layui-btn" onclick="onClickAdd()" value="查询" /> &nbsp;&nbsp; </ll:formtoolbar> </ll:ajaxform> </ll:fillareatb> <ll:fillareatb height="40px">
			...
			</ll:fillareatb> <ll:fillareatb height="*"> <ll:ajaxgrid id="lltestdatagrid" onrowclick="rowClickTest()"
			...
			></ll:gridfield> <ll:gridfield field="cdlj" title="菜单链接"></ll:gridfield> <ll:gridfield field="cjsj" title="创建时间"></ll:gridfield> <ll:gridfield field="gxsj"
				title="更新时间"
			></ll:gridfield> </ll:datagrid></ll:fillareatb> </ll:filllayout>
		</div>
