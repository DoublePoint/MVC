...
* 修   改   人：          修   改   日   期：
*/
package cn.doublepoint.jdbc.util;
...
public class JDBCUtil implements BaseRepositoryUtil {
	...
	@Override
	public <T extends BaseModel> List<T> executeQuery(String sql,Object[] params, final Class<T> clas) {
		return commonTemplate.queryForList(sql, params, clas);
	}
