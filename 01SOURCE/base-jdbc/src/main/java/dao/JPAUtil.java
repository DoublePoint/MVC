...
//	 * @ 出错抛出异常
//	 */
//	public static <T extends BaseModel> void saveOrUpdate(Collection<T> entities)
//			 {
//		IDAO dao = getBaseDAO();
//		dao.update(entities);
//	}
...
//	 * @ 出错抛出异常
//	 */
//	public static <T extends BaseModel> List<T> loadAll(Class<T> clazz,SortParamList sortParams)
//			 {
//		IDAO dao = getBaseDAO();
...
//	 * @ 出错抛出异常
//	 */
//	public static List<Object> find(String jpql, QueryParamList params, SortParamList sortParams)
//			 {
...
//	 */
//	public static List<Object> find(String jpql, QueryParamList params,
//			String extJpql, QueryParamList extParams, SortParamList sortParams, PageInfo pageInfo)
//			 {
//		IDAO dao = getBaseDAO();
...
//	 * @ 出错抛出异常
//	 */
//	public static List<Object> executeNativeQueryMapping(String nativeSql,String resultMapping)
//			 {
//		IDAO dao = getBaseDAO();
...
//	 * @
//	 */
//	public static int executeNativeUpdate(String nativeSql, QueryParamList params)
//			 {
//		IDAO dao = getBaseDAO();
...
//	 * @ 出错抛出异常
//	 */
//	public static Object executeProcWithResult(String procName, Object[] params)
//			 {
//		IDAO dao = getBaseDAO();
