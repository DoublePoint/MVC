...
<template>
  <div class="block">
    ...
    <ll-carousel height="150px">
      <ll-carousel-item v-for="item in 4" :key="item">
        <h3>{{ item }}</h3>
      </ll-carousel-item>
    </ll-carousel>
  </div>
  <div class="block">
    ...
    <ll-carousel trigger="click" height="150px">
      <ll-carousel-item v-for="item in 4" :key="item">
        <h3>{{ item }}</h3>
      </ll-carousel-item>
    </ll-carousel>
...
```html
<template>
  <ll-carousel indicator-position="outside">
    <ll-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </ll-carousel-item>
  </ll-carousel>
...
```html
<template>
  <ll-carousel :interval="5000" arrow="always">
    <ll-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </ll-carousel-item>
  </ll-carousel>
...
```html
<template>
  <ll-carousel :interval="4000" type="card" height="200px">
    <ll-carousel-item v-for="item in 6" :key="item">
      <h3>{{ item }}</h3>
    </ll-carousel-item>
  </ll-carousel>
</template>
