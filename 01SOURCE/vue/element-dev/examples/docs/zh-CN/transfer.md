...
```html
<template>
  <ll-transfer v-model="value1" :data="data"></ll-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <ll-transfer
      ...
      @change="handleChange"
      :data="data">
      <ll-button class="transfer-footer" slot="left-footer" size="small">操作</ll-button>
      <ll-button class="transfer-footer" slot="right-footer" size="small">操作</ll-button>
    </ll-transfer>
  </div>
